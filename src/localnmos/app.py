...
class LocalNMOS(toga.App):
    ...
    def _draw_matrix_grid(self, senders, receivers, matrix_width, matrix_height):
        # Draw matrix grid
    ...
    def _draw_axis_labels(self, senders, receivers, matrix_width, matrix_height, receivers_label_x_offset):
        # Draw axis labels
    ...
    def _draw_connection_labels(self, senders, receivers, matrix_width, matrix_height, receivers_label_x_offset):
    ...
    def draw_routing_matrix(self):
        ...
        self._draw_matrix_grid(senders, receivers, matrix_width, matrix_height)
        self._draw_axis_labels(senders, receivers, matrix_width, matrix_height, receivers_label_x_offset)
        self._draw_connection_labels(senders, receivers, matrix_width, matrix_height, receivers_label_x_offset)
        self._draw_checkmarks_for_routing_connections(senders, receivers, matrix_width, matrix_height)
